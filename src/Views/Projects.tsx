...
const projects: IProjects[] = [
  ...
  },
  {
    name: "Play Memories",
    description:
      "Apart from being a programmer, I also have a photography business, that's why I created my own photography website",
  ...
  },
  {
    name: "Totally Recipe",
    description:
      "This website is to provide information to everyone about recipes from food using the public api from edamam.com",
  ...
  },
  {
    name: "Blog App CMS",
    description:
      "I have created a simple blog with content management system with supabase / postgresql and next js 13",
          ...
          return (
            ...
            >
              ...
              <button
                ...
                className="bg-white px-3 py-2 flex justify-center gap-3 text-[#0F0F0F] dark:text-white dark:bg-[#0F0F0F] rounded-lg items-center"
              >
