...
export const Popup: FC<TPopup> = ({ handleClose }) => {
    ...
    return (
        <div className="fixed w-[100vw] h-screen bg-black bg-opacity-50 flex items-center justify-center z-[99] top-0 right-0">
            <div className="bg-white rounded-lg p-20 opacity-100  flex gap-8 relative text-[#010138] relative">
                <Button label="Download" handleClick={() => { }} style="text-white bg-[#010138]" />
                <div
